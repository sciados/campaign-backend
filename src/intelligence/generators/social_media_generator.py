...
New Implementation: src/content/generators/social_media_generator.py
...
import warnings
warnings.warn(
    f"src.intelligence.generators.social_media_generator is deprecated. Use src.content.generators.social_media_generator instead.",
    DeprecationWarning,
    stacklevel=2
)
