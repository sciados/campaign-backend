# src/landing_pages/routes.py
"""
Landing Page Routes - Main API endpoints for landing page generation and management
"""
...
from src.intelligence.generators.landing_page.analytics.events import EventType
...
async def generate_landing_page(
    ...
    {
        "campaign_id": "uuid",
        "page_type": "sales|lead_gen|product|service",
        "preferences": {
            "color_scheme": "modern|classic|vibrant",
...
async def track_analytics_event(
    ...
    Request body:
    {
        "event_type": "page_view|cta_click|form_start|conversion|scroll_depth",
        "event_data": {
            "scroll_percentage": 75,
            "cta_element": "hero_button",
...
async def get_landing_page_analytics(
    ...
    Query parameters:
    - time_window_hours: Analytics time window (default: 24 hours)
    """
