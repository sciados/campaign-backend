...
# Add this to your routes.py to debug the database storage issue

@router.get("/debug/test-database-storage")
async def debug_database_storage():
    ...
    try:
        ...
        try:
            # Try to import the validation function from routes.py
            from src.intelligence.routes import validate_intelligence_section
...
@router.get("/debug/test-routes-validation")
async def debug_routes_validation():
    ...
    try:
        ...
        try:
            # Check if ensure_intelligence_structure exists
            from src.intelligence.routes import ensure_intelligence_structure
            structure_function_available = True
        except ImportError:
            structure_function_available = False
        
        try:
            # Check if validate_intelligence_section exists  
            from src.intelligence.routes import validate_intelligence_section
            validation_function_available = True
