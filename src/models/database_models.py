...
Replaces the old flat campaign_intelligence table with normalized structure.
"""
...
# NEW OPTIMIZED SCHEMA MODELS - Replace campaign_intelligence table
class IntelligenceCore(Base):
    """Core intelligence table - replaces campaign_intelligence"""
